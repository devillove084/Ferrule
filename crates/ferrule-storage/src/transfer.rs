...
use crate::replica::ReplicaHandleId;
use crate::residency::{ResidencyPriority, ResidencyReason, ResidencyRequest};
...
pub struct TransferTicket {
    pub id: u64,
    pub object: crate::id::StorageObjectId,
}
...
pub struct MockTransferEngine {
    ...
    pub last_ensure_object: Option<crate::id::StorageObjectId>,
...
impl MockTransferEngine {
    ...
    pub fn queue_completion(&mut self, ticket: u64, object: crate::id::StorageObjectId) {
