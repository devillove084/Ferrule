#ifndef FERRULE_CUDA_CUTLASS_CAPABILITIES_PROPOSAL_HEAD_CUH_
#define FERRULE_CUDA_CUTLASS_CAPABILITIES_PROPOSAL_HEAD_CUH_
...
#include "bf16_compressor.cuh"

namespace ferrule::cuda::cutlass::capabilities::proposal_head {

namespace bf16 = ferrule::cuda::cutlass::capabilities::bf16_compressor;
...
inline Status launch(const Args *args) {
  ...
  const dim3 base_grid((args->vocab + bf16::kCtaColumns - 1u) /
                           bf16::kCtaColumns,
                       (args->rows + bf16::kCtaRows - 1u) / bf16::kCtaRows, 1u);
...
#endif // FERRULE_CUDA_CUTLASS_CAPABILITIES_PROPOSAL_HEAD_CUH_
