#ifndef FERRULE_CUDA_CUTLASS_CAPABILITIES_MAIN_PROJECT_NORM_CUH_
#define FERRULE_CUDA_CUTLASS_CAPABILITIES_MAIN_PROJECT_NORM_CUH_
...
#include "../architectures/mma.cuh"

#include <cstddef>
#include <cstdint>
#include <type_traits>

namespace ferrule::cuda::cutlass::capabilities::main_project_norm {
...
inline constexpr std::uint32_t kCooperativeBlockLimit =
    architectures::ActiveProfile::kCooperativeBlockLimit;
...
__device__ __forceinline__ void mma_fp8(float (&accumulator)[4],
  ...
  architectures::fp8_e4m3_m16n8k32(accumulator, weight, activation);
}
...
#endif // FERRULE_CUDA_CUTLASS_CAPABILITIES_MAIN_PROJECT_NORM_CUH_
