#ifndef FERRULE_CUDA_CUTLASS_CAPABILITIES_MLA_OUTPUT_CUH_
#define FERRULE_CUDA_CUTLASS_CAPABILITIES_MLA_OUTPUT_CUH_
...
namespace ferrule::cuda::cutlass::capabilities::mla_output {
...
#endif // FERRULE_CUDA_CUTLASS_CAPABILITIES_MLA_OUTPUT_CUH_
