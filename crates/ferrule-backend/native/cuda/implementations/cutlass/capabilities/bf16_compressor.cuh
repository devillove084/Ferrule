#ifndef FERRULE_CUDA_CUTLASS_CAPABILITIES_BF16_COMPRESSOR_CUH_
#define FERRULE_CUDA_CUTLASS_CAPABILITIES_BF16_COMPRESSOR_CUH_
...
namespace ferrule::cuda::cutlass::capabilities::bf16_compressor {
...
stage_activation(SharedStorage &shared, const float *activation,
                 const Args &args, std::uint32_t m_base, std::uint32_t k_base) {
...
__device__ __forceinline__ void
store_projection(float *output, const Args &args, std::uint32_t channel_count,
...
#endif // FERRULE_CUDA_CUTLASS_CAPABILITIES_BF16_COMPRESSOR_CUH_
