...
pub struct CudaOpCounters {
    ...
    pub compute_kernel_launches: u64,
    pub upload_kernel_launches: u64,
...
pub(crate) struct CudaOpCounterCells {
    ...
    compute_kernel_launches: Cell<u64>,
    upload_kernel_launches: Cell<u64>,
...
impl CudaOpCounterCells {
    pub(crate) fn snapshot(&self) -> CudaOpCounters {
        CudaOpCounters {
            ...
            compute_kernel_launches: self.compute_kernel_launches.get(),
            upload_kernel_launches: self.upload_kernel_launches.get(),
    ...
    pub(crate) fn reset(&self) {
        ...
        self.compute_kernel_launches.set(0);
        self.upload_kernel_launches.set(0);
    ...
    pub(crate) fn add_compute_kernel_launch(&self) {
        self.add_compute_kernel_launches(1);
    }

    pub(crate) fn add_compute_kernel_launches(&self, count: u64) {
        self.kernel_launches
            .set(self.kernel_launches.get().saturating_add(count));
        self.compute_kernel_launches
            .set(self.compute_kernel_launches.get().saturating_add(count));
    }

    pub(crate) fn add_upload_kernel_launch(&self) {
        self.kernel_launches
            .set(self.kernel_launches.get().saturating_add(1));
        self.upload_kernel_launches
            .set(self.upload_kernel_launches.get().saturating_add(1));
    }
    ...
    pub(crate) fn add_moe_call(&self) {
