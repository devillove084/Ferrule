...
use super::descriptor::StorageObjectDescriptor;
...
mod tests {
    use super::*;
    use crate::storage::descriptor::{
        StorageMutability, StorageObjectDescriptor, StorageObjectKind,
    };
    use crate::storage::id::{ModelRevision, StorageObjectId};
    use crate::storage::layout::StorageLayout;
    use crate::storage::locator::ObjectLocator;
