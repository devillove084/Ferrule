...
fn model_rev(n: u64) -> ferrule_runtime::storage::ModelRevision {
    ferrule_runtime::storage::ModelRevision(n)
}
...
fn device_placement() -> Placement {
    Placement::Local(ferrule_runtime::storage::LocalPlacement::Device {
        device_id: 0,
        memory: ferrule_runtime::storage::DeviceMemoryKind::Vram,
    })
}

fn host_placement() -> Placement {
    Placement::Local(ferrule_runtime::storage::LocalPlacement::Host { pinned: true })
}
...
fn placement_tier_rank_orders_correctly() {
    ...
    let disk = Placement::Local(ferrule_runtime::storage::LocalPlacement::Disk { volume: None });
    let remote = Placement::Remote(ferrule_runtime::storage::RemotePlacement {
        endpoint: ferrule_runtime::storage::RemoteEndpoint {
            scheme: ferrule_runtime::storage::RemoteScheme::Rdma,
            host: "peer".into(),
            port: None,
        },
        region: None,
